...
is the selection intensity of the system. We also allow for heterogeneous choice
intensity, so that $\epsilon_{ij}$ depends on the player $i$ who is changing
strategy, and the player $j$ who is being considered.
