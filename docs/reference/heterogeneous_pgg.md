# heterogeneous_pgg_fitness_function

```
ludics.fitness_functions.heterogeneous_pgg_fitness_function(state, r, contribution_vector, **kwargs)
```
...
- `r`: _numpy.array_ - the ratio by which the contributions are multiplied
